...
public static class PatchExtensions
{
    ...
    public static string ToPatchName(this Patch value)
    {
        ...
        {
            20 => Localize.Text("A Realm Reborn"),
            21 => Localize.Text("A Realm Awoken"),
            22 => Localize.Text("Through The Maelstrom"),
            23 => Localize.Text("Defenders Of Eorzea"),
            24 => Localize.Text("Dreams Of Ice"),
            25 => Localize.Text("Before The Fall"),
            30 => Localize.Text("Heavensward"),
            31 => Localize.Text("As Goes Light, So Goes Darkness"),
            32 => Localize.Text("The Gears Of Change"),
            33 => Localize.Text("Revenge Of The Horde"),
            34 => Localize.Text("Soul Surrender"),
            35 => Localize.Text("The Far Edge Of Fate"),
            40 => Localize.Text("Stormblood"),
            41 => Localize.Text("The Legend Returns"),
            42 => Localize.Text("Rise Of A New Sun"),
            43 => Localize.Text("Under The Moonlight"),
            44 => Localize.Text("Prelude In Violet"),
            45 => Localize.Text("A Requiem For Heroes"),
            50 => Localize.Text("Shadowbringers"),
            51 => Localize.Text("Vows Of Virtue, Deeds Of Cruelty"),
            52 => Localize.Text("Echoes Of A Fallen Star"),
            53 => Localize.Text("Reflections In Crystal"),
            54 => Localize.Text("Futures Rewritten"),
            55 => Localize.Text("Death Unto Dawn"),
            60 => Localize.Text("Endwalker"),
            61 => Localize.Text("Newfound Adventure"),
            62 => Localize.Text("Buried Memory"),
            63 => Localize.Text("Gods Revel, Lands Tremble"),
            64 => Localize.Text("The Dark Throne"),
            65 => Localize.Text("Growing Light"),
            70 => Localize.Text("Dawntrail"),
            71 => Localize.Text("Crossroads"),
            72 => Localize.Text("Seekers of Eternity"),
            73 => Localize.Text("The Promise of Tomorrow"),
            74 => Localize.Text("Into the Mist"),
            75 => Localize.Text("Trail to the Heavens"),
            _  => Localize.Text("Unknown"),
        };
    }
