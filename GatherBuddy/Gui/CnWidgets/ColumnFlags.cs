// Adapted from Ottermandias/OtterGui (Table/ColumnFlags.cs).
...
public class CnColumnFlags<T, TItem> : Column<TItem> where T : struct, Enum
{
...
public abstract class CnTriStateColumnFlags<T, TItem> : Column<TItem> where T : struct, Enum
{
    public    T               AllFlags   = default;
    protected ImGuiComboFlags ComboFlags = ImGuiComboFlags.NoArrowButton;
