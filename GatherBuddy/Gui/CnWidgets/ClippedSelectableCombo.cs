// Adapted from Ottermandias/OtterGui (Widgets/ClippedSelectableCombo.cs).
...
public class CnClippedSelectableCombo<T>
{
    ...
    public CnClippedSelectableCombo(string id, string label, float previewSize, IList<T> items, Func<T, string> itemToName)
    {
    ...
    private bool DrawList(string currentName, out int selectedIdx)
    {
        ...
        OtterGui.ImGuiClip.ClippedDraw(_remainingItems, DrawItemInternal, height);
