// Adapted from Ottermandias/OtterGui (Widgets/FilteredCombo.cs).
...
public abstract class CnFilterComboBase<T>
{
    ...
    protected CnFilterComboBase(IReadOnlyList<T> items, bool keepStorage, Logger log)
    {
        Items        = items;
