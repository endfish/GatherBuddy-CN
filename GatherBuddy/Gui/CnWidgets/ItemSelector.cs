// Adapted from Ottermandias/OtterGui (ItemSelector.cs).
...
public class CnItemSelector<T>
{
    ...
    public CnItemSelector(IList<T> items, Flags flags = Flags.None)
    {
        Items         = items;
    ...
    private unsafe void InternalDraw(int idx)
    {
        ...
        // If the CnItemSelector supports Move, every item is a Move-DragDropSource. The data is the index of the dragged element.
        ...
        // If the CnItemSelector supports Move or Drop, every item is a DragDropTarget.
